...
const founderImg = '/src/assets/images/siyanto_high_res_1780298450526.png';

export default function FoundersMessage() {
  return (
    <div className="bg-slate-950/40 rounded-3xl p-6 sm:p-8 border border-red-950/40" id="tentang-kami">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-5 relative group">
          ...
          <div className="relative rounded-2xl overflow-hidden border-2 border-slate-800 bg-slate-900 aspect-[4/5] sm:aspect-[3/4]">
            {/* Gemini AI Indicator Badge */}
            <div className="absolute top-3 left-3 bg-slate-950/80 backdrop-blur-md border border-white/10 px-2.5 py-1 rounded-md flex items-center gap-1.5 z-10 select-none pointer-events-none">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse shadow-md shadow-blue-500/50" />
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-950/60 to-transparent p-6 pt-12 text-center">
              <span className="block font-display text-white text-lg font-bold">Siyanto Dsantoso</span>
              <span className="block text-xs text-gold-400 font-mono mt-1">Founder / Kepala Lab Mikro-Solder</span>
              <span className="inline-block mt-2 bg-red-950/80 border border-red-500/25 text-[10px] font-mono text-red-500 px-2 py-0.5 rounded-full">
                Circuit Specialist (Ex-OEM Lab Tech)
              </span>
            </div>
          </div>
          ...
          <div className="absolute top-4 -right-4 bg-slate-900 border border-slate-700 p-3 rounded-xl shadow-2xl skew-y-1 select-none pointer-events-none hidden sm:block">
            ...
            <span className="block text-sm font-bold text-red-500 font-mono">99.7% Success</span>
          </div>
